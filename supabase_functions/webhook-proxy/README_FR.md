Proxy de Webhooks - Edge Function (Supabase)

Ce document explique comment déployer la fonction Edge qui sert de proxy sécurisé pour les webhooks externes.

Pré-requis :
- Supabase CLI installé
- Projet Supabase avec accès pour déployer des Edge Functions
...
Limites :
- Cette fonction est un proxy simple. Pour l'upload de photos, implémentez un upload direct vers Supabase Storage et transmettez les URLs dans le payload.
